...
Class Assets
	...
	Method New()
		...
		graphics.Add(GFX_RAILROAD_ROCK, Image.Load(GFX_RAILROAD_ROCK, 0.0, 0.0))
		...
		anims.Add(GFX_ANIM_SURVIVOR, Image.LoadFrames(GFX_ANIM_SURVIVOR, ANIMS_FRAMES_SURVIVOR, False, .5, 0))
