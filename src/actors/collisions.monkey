...
Private
	...
	Function CheckOneSideCollision:Bool(box1:CollisionBox, box2:CollisionBox)
		Return box1.lowerRight[0] >= box2.upperLeft[0] And box1.lowerRight[0] <= box2.lowerRight[0] And box1.lowerRight[1] >= box2.upperLeft[0] And box1.lowerRight[1] <= box2.lowerRight[1]
		Return True
	End Function
